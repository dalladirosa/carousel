...
const SecuritySection = () => {
  return (
    <section className="container w-full lg:px-8">
      <div className="flex flex-row gap-10 p-10">
        <div className="flex flex-shrink-0 flex-col">
          ...
          <p className="mt-2 text-5xl text-gray-990">
            Your Data’s{' '}
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-row gap-6 rounded-3xl border border-white bg-gray-100 px-6 py-10">
