...
export default function HeroSection() {
  ...
  return (
    <section className="container flex w-full flex-col items-center px-0 lg:px-8">
      <div className="w-full rounded-3xl rounded-t-[2.5rem] bg-primary-purple-45 pb-32 pt-20 lg:pt-32">
        {/* TODO: Add Animation */}
        ...
        <div className="relative flex w-full flex-col items-center justify-evenly px-6 pt-20 lg:px-0 lg:pt-32">
          <div className="rounded-[24px] border border-purple-15 bg-white px-6 py-4 shadow-[0px_6px_6px_rgba(0,_0,_0,_0.06),_0px_2px_6px_rgba(0,_0,_0,_0.04),_0px_0px_1px_rgba(0,_0,_0,_0.04)] ring-2 ring-black-30 ring-offset-8 ring-offset-primary-purple-45">
